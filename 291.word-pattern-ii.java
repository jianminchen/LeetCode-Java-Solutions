public class Solution {
    public boolean wordPatternMatch(String pattern, String str) {
    	// given a pattern, check if the str matches with the pattern
    	// example: "aba", "aboutsomeabout".
    	// the same char will map to the same word.
    	// the different chars will map to different words.
    ...
    public boolean wordPatternMatch(Set<String> set, Map<Character, String> hm, String pattern, String str) {
