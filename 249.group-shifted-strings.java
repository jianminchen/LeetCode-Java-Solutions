...
public class Solution {
    public List<List<String>> groupStrings(String[] strings) {
        ...
        for (int i = 0; i < strings.length; i ++) {
            ...
            if (hm.containsKey(pattern)) hm.get(pattern).add(strings[i]);
            else {
    ...
    public String shiftingBack(String s) {
        // a string that may or may not starts with a.
        // shift back to a pattern.
